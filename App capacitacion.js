...
const searchMatch = !q || (v.titulo||'').toLowerCase().includes(q)
...
fi.accept = tipo === 'pdf' ? '.pdf' : '.ppt,.pptx';
document.getElementById('fdoc-drop-hint').textContent =
tipo === 'pdf' ? 'PDF — sin límite de tamaño' : 'PPT, PPTX — sin límite de tamaño';
};
